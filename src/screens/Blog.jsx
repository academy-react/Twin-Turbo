                ...
                <div className="w-[full] h-[1400px] flex justify-center items-center gap-[50px]">
                    ...
                    <div className="w-[60%] h-[1300px] rounded-xl shadow-[0_0_7px_#ddd] bg-white ">
                        ...
                        <div dir='rtl' className='w-full h-[600px] px-[20px]'>
                            <button className='p-[10px] border borde-[green] relative right-[35px] top-[8px] rounded-xl ' onClick={(e)=> change(1,e.target)}>نظرات</button>
                            <button className='p-[10px] border borde-[green] relative right-[65px] top-[8px] rounded-xl ' onClick={(e)=> change(2,e.target)}>توضیحات</button>
