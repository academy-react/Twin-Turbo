  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-r from-[#66008C] to-[#9F0099]'>
      <div className='w-[1280px] mx-auto h-full relative overflow-hidden '>
          ...
          <img src="../src/assets/images/login.png" alt="" className='absolute left-[-210px] top-[140px] scale-[65%] '/>

          <div className="w-[400px] h-[410px] bg-white absolute right-[15%] top-[170px] shadow-[0_0_7px_#ccc] rounded-[15px] flex flex-col justify-around items-center py-4">
