  ...
  return (
    <div className=' w-[1920px] mx-[auto]'>
        <div className='w-full h-[400px] flex flex-col items-center justify-center'>
          ...
          <Link className="w-[20%] h-[52px] rounded-[15px] bg-[#A644C1] flex justify-center items-center text-[#fff] cursor-pointer hover:bg-[#8e2aae] transition-all duration-300">بازگشت به صفحه اصلی</Link>
        </div>
        <Footer />
    </div>
  )
