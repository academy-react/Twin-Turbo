    ...
    <>
      <div className="w-[1920px] mx-[auto]">
        ...
        <div className="w-[full] flex justify-center gap-[50px] my-5">
          <div  dir="ltr"  className="w-[30%] flex flex-col items-center justify-center rounded-xl shadow-[0_0_7px_#ddd] bg-white py-5">
            <div className="w-[80%] rounded-2xl bg-white shadow-[0_0_7px_#ddd] flex flex-col my-5 [&>div:nth-child(even)]:bg-[#f5f5f5]" >
              ...
              <CourseDetail content="Angular" title="نام دوره" logo="courseName.png" />
              <CourseDetail content="Angular" title="ترم ارائه" logo="terms.png" />
              <CourseDetail content="1402/7/7" title="شروع ترم" logo="startTerm.png" />
              <CourseDetail content="1402/7/16" title="پایان ترم" logo="endTerm.png" />
            </div>
            <div className="w-[80%] rounded-2xl bg-white shadow-[0_0_7px_#ddd] flex flex-col my-5 [&>div:nth-child(even)]:bg-[#f5f5f5]" >
            ...
            <div className="w-[80%] rounded-2xl bg-white shadow-[0_0_7px_#ddd] flex flex-col my-5 [&>div:nth-child(even)]:bg-[#f5f5f5]" >
              ...
              <div className="text-[#444] text-[22px] self-end m-3"> : راه های ارتباطی</div>
              <CourseDetail content="bahroololoom@gmail.com" title="آدرس ایمیل" noLogo="hidden" />
              <CourseDetail content="bahr_ac" title="اینستاگرام" noLogo="hidden" />
            </div>
            ...
            <div className="w-[80%] rounded-2xl bg-white shadow-[0_0_7px_#ddd] flex flex-col my-5 [&>div:nth-child(even)]:bg-[#f5f5f5]" >
              <div className="text-[24px] self-end m-3">مزایای شرکت در دوره</div>
              <CourseDetail content="" title="ارتباط مستقیم با مدرس" logo="advantage.png" />
              <CourseDetail content="" title="ساخت رزومه مناسب برای بازار کار" logo="advantage.png" />
