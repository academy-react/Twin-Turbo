...
let registerValidation = yup.object().shape({
    ...
    PhoneNumberOrGmail : yup.string().matches(/(0|\+98)?([ ]|-|[()]){0,2}9[1|2|3|4|5|9]([ ]|-|[()]){0,2}(?:[0-9]([ ]|-|[()]){0,2}){8}/ , "لطفا شماره را به درستی وارد کنید").max(10 , "لطفا شماره را به درستی وارد کنید").required("لطفا شماره همراه را وارد کنید"),
