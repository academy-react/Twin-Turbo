...
const create = async (parentItem,element,url) => {
    ...
    resultReply.map((element,index)=> {
        ...
        likeImg.onclick = (e)=> likeDissLikeCourse(element.id,"Like",true,element,e,url)
        ...
        dissLikeImg.onclick = (e)=> likeDissLikeCourse(element.id,"DissLike",false,element,e,url)
