  ...
  return (
    <>
        <div dir={dir} className={"dark:bg-[#26324D] relative w-[85%] flex justify-between items-center rounded-lg pr-[15px] overflow-hidden " + border }>
          ...
          <Field name={name} as={as} type={type} className={"dark:bg-transparent dark:placeholder:text-white dark:text-white text-[18px] w-full placeholder:text-[#5a0ba951] text-[#5A0BA9]  border-[rgba(112,112,112,0.14)] outline-none rounded-lg h-12 pl-5 " + className } placeholder={placeholder} />
