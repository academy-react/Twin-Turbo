...
const Menu = () => {
    return (
      ...
      <div className="w-full h-[80px] flex [&>div>a]:text-[13px] [&>div>a]:text-[#777] [&>div>img]:ml-[10px]">
          <Link to={'/login'} className="h-full w-[50%] flex justify-center items-center max-[600px]:[&>div]:text-[13px]">
            <div>ورود</div>
            <img src="../../src/assets/images/panel/log-in.png" alt="" className="h-[20px] ml-2"/>
          </Link>
          <Link to={'/register'} className="h-full w-[50%] flex justify-center items-center max-[600px]:[&>div]:text-[13px]">
            <div>ثبت نام</div>
      ...
      <div dir="rtl" className="w-full h-[250px] flex flex-col [&>a]:h-[40px] [&>a]:flex [&>a]:items-center [&>a]:pr-[5px] [&>a]:text-[16px] max-[600px]:[&>a]:text-[13px] [&>a:hover]:bg-[#eee]">
        ...
        <Linkes to={"/courses"} src="header/education.png" imgClassName="w-[25px] h-[25px]" content="آموزش" acceptedClassName="bg-gradient-to-r from-[rgb(102,0,140)] to-[#000] text-[#000] " ejectedClassName="bg-none text-[#888]" />
