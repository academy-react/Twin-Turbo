      ...
      <header dir="rtl" className="z-[100] relative w-full right-0 left-0 top-0 max-h-[80px]" id="header">
          <div className="mx-auto w-[1920px] h-full flex justify-between max-[1919px]:w-full items-center" >
              <div className="w-[35%] max-[1580px]:w-[40%] max-[1580px]:[&>a]:text-[16px] max-[1020px]:hidden whitespace-nowrap h-full flex  justify-around items-center [&>a]:pb-2 px-4 [&>a]:text-[20px] flex-row-reverse max-[1200px]:[&>a]:text-[15px]">
                  <Linkes to="/contact-us" content="تماس با ما" imgClassName="hidden" ejectedStyle="none" acceptedClassName={"text-[" + color + "] border-b-[2px] border-b-[#8043bd]"} ejectedClassName={"text-[" + color + "] headerItemHover relative"} />
                  <Linkes to="/blogs" content="خدمات" imgClassName="hidden" ejectedStyle="none" acceptedClassName={"text-[" + color + "] border-b-[2px] border-b-[#8043bd]"} ejectedClassName={"text-[" + color + "] headerItemHover relative"} />
                  <Linkes to="/courses" content="آموزش" imgClassName="hidden" ejectedStyle="none" acceptedClassName={"text-[" + color + "] border-b-[2px] border-b-[#8043bd]"} ejectedClassName={"text-[" + color + "] headerItemHover relative"} />
                  <Linkes to="/" content="خانه" imgClassName="hidden" ejectedStyle="none" acceptedClassName={"text-[" + color + "] border-b-[2px] border-b-[#8043bd]"} ejectedClassName={"text-[" + color + "] headerItemHover relative"} />
              ...
              <div className={"relative max-[799px]:w-[20%] max-[1400px]:[&>*]:scale-[95%] max-[599px]:w-[30%] max-[399px]:w-[40%] max-[325px]:w-[54%] max-[1020px]:w-[15%] max-[1080px]:w-[33%] w-[400px] max-[1400px]:w-[30%] max-[1280px]:[&>*]:scale-[90%] h-full flex justify-around items-center pl-1 text-[#8043bd] [&>a]:h-[45px] [&>a]:bg-[#f1ebf8] [&>a]:mx-[8px] [&>a]:rounded-[30px] [&>a]:flex [&>a]:justify-center [&>a]:items-center [&>a]:whitespace-nowrap [&>a]:text-[18px] [&>a]:cursor-pointer [&>a:nth-child(3)]:max-[1020px]:hidden [&>a:nth-child(4)]:max-[1020px]:hidden [&>a]:shadow-[0px_3px_6px_#5757574f] " + className}>
                  <NightMode bgClass="bg-[#f1ebf8] px-[8px] " borderClass="border-4 border-black" />
