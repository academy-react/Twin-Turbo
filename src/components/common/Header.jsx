...
const Header = ({className,src,color}) => {
  ...
  return (
    <header dir="rtl" className="w-full right-0 left-0 top-0 h-[80px] z-50 " id="header">
        <div className="mx-auto w-[1920px] h-full flex justify-between max-[1919px]:w-full " >
            <div className="w-[35%] max-[1280px]:w-[45%] max-[1020px]:hidden whitespace-nowrap h-full flex  justify-around items-center [&>a]:pb-2 px-4 [&>a]:text-[20px] flex-row-reverse">
