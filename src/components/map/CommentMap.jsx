                    ...
                    <div className="w-full h-[100%] bg-white shadow-[0_0_7px_#999] rounded-[15px] p-[10px] relative">
                        ...
                        <div className="w-[110px] h-[25px] flex justify-evenly items-center my-1">
                            <div className=" flex items-center"  >
                                ...
                                <img src="../src/assets/images/like.png" className="mx-2 scale-125 cursor-pointer" data-id={`${index}`} onClick={(e)=> !like ? likeUp(e,db,disLike,setLike,url) : likeDown(e,db,disLike,setLike,url)} /> 
                            </div>
                            |
                            <div className="flex items-center mr-2" >
                                <span className="text-[#ec0b1a]">{element.dislike}</span> 
                                <img src="../src/assets/images/dislike.png" className="mr-2 scale-125 cursor-pointer" data-id={`${index}`} onClick={(e)=> !disLike ? disLikeUp(e,db,like,setDisLike,url) : disLikeDown(e,db,like,setDisLike,url)}/>
                            </div>
                        </div>
