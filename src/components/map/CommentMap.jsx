            ...
            return (
                <div key={index} className="w-full flex items-center gap-[15px] my-[7px] py-5 " data-id="1" >
                    ...
                    <div className="w-full h-[100%] bg-white shadow-[0_0_7px_#999] rounded-[15px] p-[10px] relative">
                        <div  className="text-[18px] my-1 flex [&>span]:mx-[10px]"><span className='order-1'>{element?.author ? element.author : "بدون نام"}</span>  <span className='order-2'>|</span>  <span span className='order-2'>{element.insertDate?.slice(11,19)}</span>  </div>
                        <div></div>
                        ...
                        <div className="w-[130px] h-[25px] flex justify-evenly items-center my-1">
                            ...
                            <div className="flex items-center mr-2" >
                                <span className="text-[#ec0b1a]">{element?.disslikeCount}</span> 
