...
const News = () => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className=" w-[95%] flex [&>div]:w-[50%] [&>div]:shadow-[0_0_7px_#ccc] [&>div]:mx-3 [&>div]:relative [&>div]:rounded-[15px] [&>div]:flex [&>div]:justify-center [&>div]:items-center [&>div]:flex-col [&>div]:h-[400px] max-[1050px]:flex-col max-[1050px]:[&>div]:mx-auto max-[1050px]:[&>div]:w-[85%] max-[1050px]:[&>div]:my-[10px] max-[600px]:w-[95%] max-[600px]:[&>div]:w-[400px] max-[450px]:[&>div]:w-full ">
