...
const ItemLandingNews = ({ image }) => {
  return (
    <>
      <div dir="rtl" className="w-[95%] h-[120px] px-5 rounded-xl shadow-[0_-5px_5px_#dddf] max-[600px]:my-2 flex flex-row-reverse justify-around items-center max-[1400px]:[&>p]:text-[18px] max-[600px]:flex-col-reverse max-[600px]:h-[145px]">
