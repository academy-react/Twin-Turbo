...
const Recommands = () => {
  return (
    <div className='w-full h-[870px] flex flex-col justify-center items-center pt-[10px] relative mb-[100px] max-[480px]:mb-[-50px]'>
        ...
        <Formik initialValues={{name:"",email:"",textarea:"",bool:false}} onSubmit={(values)=> ppp(values)} validationSchema={recommandsValidation}>
            {(form) => (
                ...
                <Form className="w-full relative h-[65%] mt-28 max-[1510px]:mt-5 max-[1170px]:flex justify-center">
                    ...
                    <div className="h-[700px] mt-[-25px] py-5 w-[600px] shadow-[0_0_7px_#ddd] opacity-0 bg-white absolute right-24 top-0 rounded-3xl flex flex-col items-center justify-evenly transition-all duration-1000 max-[1630px]:scale-[90%] max-[1510px]:scale-[80%] max-[1510px]:w-[550px] max-[1170px]:relative max-[1170px]:left-[5px] max-[400px]:scale-[80%] max-[500px]:top-[-80px] max-[650px]:w-[700px] max-[500px]:h-[400px] " id="recommandsForm">
