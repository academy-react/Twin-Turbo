...
const Services = () => {
  ...
  return (
    <div className='h-[700px] max-[780px]:h-[500px] w-[full] flex flex-col justify-center items-center relative'>
      ...
      <div className='max-[420px]:w-[350px] max-[420px]:[&>*]:h-[45%] max-[380px]:[&>*]:h-[40%] max-[351px]:w-[300px] w-[650px] flex flex-wrap justify-between scale-[0.01%] transition-all duration-1000 max-[1640px]:w-[570px] max-[1490px]:w-[530px] max-[1350px]:w-[500px] max-[1350px]:h-[250px] max-[770px]:w-[400px] max-[770px]:h-[200px]' id='holder'>
