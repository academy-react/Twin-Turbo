...
const Services = () => {
  ...
  return (
    <div className='h-[700px] w-[full] max-[650px]:h-[850px] flex flex-col justify-center items-center relative'>
      ...
      <img src="../src/assets/images/landingService/Group 159.png" alt="" className='absolute left-[-500px] bottom-[-70px] scale-[70%] drop-shadow-[0px_3px_6px_#5757574f] transition-all duration-1000 max-[1350px]:scale-[60%] max-[850px]:scale-[45%] max-[650px]:hidden' id='woman'/>
      <img src="../src/assets/images/landingService/Path 620.png" alt="" className='absolute left-[-250px] top-[-20px] scale-[50%] drop-shadow-[0px_3px_6px_#5757574f] transition-all duration-1000 max-[1350px]:scale-[40%] max-[850px]:scale-[30%] max-[830px]:top-[-100px] max-[850px]:left-[-265px]  max-[650px]:hidden'/>
      <img src="../src/assets/images/landingService/Group 160.png" alt="" className='absolute right-[-550px] top-[-20px] scale-[70%] drop-shadow-[0px_3px_6px_#5757574f] transition-all duration-1000 max-[1350px]:scale-[60%] max-[850px]:scale-[50%] max-[940px]:top-[-100px] max-[650px]:hidden ' id='man'/>
    </div>
  )
}
