const TitleComponents = ({title,content,src,className}) => {
  return (
    <div className={"min-w-[600px] max-[520px]:scale-[70%] mr-[-50px] max-[750px]:scale-[85%] transition-all duration-1000 max-[930px]:flex flex-col items-center justify-around max-[540px]:scale-[60%] max-[410px]:scale-[55%] max-[350px]:scale-[50%] " + className}>
