    ...
    <div className="w-full mb-10 flex flex-col justify-around items-center relative">
      ...
      <div className="w-[80%] flex justify-between max-[1023px]:justify-center">
        ...
        <div className="w-[30%] h-[750px] max-[1200px]:h-[620px] max-[1023px]:hidden rounded-3xl bg-white flex flex-col items-center justify-around [&>img]:cursor-pointer [&>img]:w-[90%] max-[1200px]:[&>img]:w-[80%] [&>img]:h-[190px] max-[1200px]:[&>img]:h-[150px] shadow-[0_0_7px_#ccc] ">
          ...
          <img src={"../src/assets/images/courses/01.png"} alt="" className="rounded-[20px]" data-id="1" onClick={(e)=> landingCourseSelector(e,bigPic.current,title.current,master.current,content.current,s.current,setNum)}/>
          <img src={"../src/assets/images/courses/react.png"} alt="" className="rounded-[20px]" data-id="2" onClick={(e)=> landingCourseSelector(e,bigPic.current,title.current,master.current,content.current,s.current,setNum)}/>
          <img src={"../src/assets/images/courses/03.png"} alt="" className="rounded-[20px]" data-id="3" onClick={(e)=> landingCourseSelector(e,bigPic.current,title.current,master.current,content.current,s.current,setNum)}/>
