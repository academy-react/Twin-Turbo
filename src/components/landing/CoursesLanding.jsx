  ...
  return (
    <div className="w-full relative max-[1600px]:flex-col">
        ...
        <div className="max-[1250px]:w-[90%] max-[700px]:[&>div]:w-[95%]  max-[820px]:[&>div]:w-[680px] max-[900px]:[&>div]:w-[800px] max-[900px]:[&>div]:mx-auto max-[1020px]:w-full max-[1020px]:flex-col-reverse max-[1020px]:items-center [&>div]:shadow-[0_0_7px_#ccc]  mx-auto [&>div]:mx-[30px] flex min-[1601px]:justify-center justify-center max-[1600px]:[&>div]:my-[15px]" >
            ...
            <div className="bg-white w-[350px] max-[820px]:h-[150px] h-[600px] rounded-[25px] flex flex-col  max-[1020px]:flex-row justify-around items-center transition-all duration-100 relative max-[1020px]:h-[200px] max-[1020px]:w-[80%] max-[450px]:h-[105px]" >
            ...
            <div className="bg-white w-[650px] max-[400px]:h-[400px] max-[963px]:h-[250px] h-[600px] relative py-[15px] rounded-[25px] transition-all duration-150 max-[1020px]:w-[80%] max-[1020px]:flex max-[1020px]:flex-row-reverse max-[1020px]:h-[300px] max-[1020px]:items-center max-[650px]:h-[400px] max-[650px]:flex-col " data-id="1" ref={landingCourse}>
                ...
                <div className="max-[650px]:mt-[-15px] max-[400px]:mt-[15px] max-[650px]:mt-[15px] max-[650px]:pr-[15px] w-[90%] mx-auto relative max-[1020px]:left-[25px] max-[1020px]:bottom-[65px] max-[960px]:bottom-[50px] max-[903px]:bottom-[40px]">
                    <div className="max-[400px]:flex-col-reverse px-[10px] max-[650px]:items-end max-[400px]:mt-[20px] h-[50px] flex justify-between items-center relative top-[10px] max-[650px]:flex-row ">
                        <div className="text-[18px] max-[500px]:text-[15px] max-[400px]:mb-[-11px]" ref={master}> استاد بحرالعلوم</div>
                        <div className="text-[24px] max-[500px]:text-[20px]" ref={title}>دوره کامل : جی اس</div>
                    </div>
