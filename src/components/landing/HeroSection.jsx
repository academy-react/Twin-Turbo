...
const HeroSection = () => {
  ...
  return (
    <div className=" w-full h-[830px] relative max-[1500px]:h-[650px]">
      <img src="../src/assets/images/bg-top.png" alt="" className="max-[1020px]:hidden w-full h-full absolute left-0 -top-[2px] scale-x-[107%] scale-y-[117%] -z-10 "/>
      <img src="../src/assets/images/woman.png" alt="" className=" absolute scale-[72%] left-[-10px] top-[80px] -z-10 max-[1500px]:scale-[50%] max-[1500px]:left-[-200px] max-[1020px]:hidden"/>
      ...
      <Header src="avatar.png" color="#5A0BA9" hClass="fixed" />
        <div dir="rtl" className=" w-[650px] h-[400px] max-[1020px]:w-full max-[1300px]:scale-[85%] max-[1300px]:right-0 max-[1020px]:items-center max-[1280px]:mx-auto flex flex-col justify-evenly absolute right-[150px] top-[200px]">
            ...
            <button ref={btn} className="bg-gradient-to-r transition-opacity max-[1020px]:mx-auto duration-[.5s] from-[#5A0BA9] to-[#C003B2] hover:bg-gradient-to-l rounded-[25px] w-[200px] h-[55px] whitespace-nowrap  text-[19px]  text-[#fff]" onClick={() => navigate("/courses")}>
              شروع یادگیری
            </button>
